...
footer_lb = tk.Label(root, text = "Developed by Mahesh K", font = ('arial', 10, 'italic'))
    ...
    def announcements_page():
        ...
        def send_announcement(email_addresses):
            ...
            for email in email_addresses:
                ...
                send_mail_to_student(email = email, subject = "[ACTION REQUIRED] Important Announcement Students", message = message)
                sent_count += 1
                sending_lb.config(text = f"Sending To:\n{email}\n\n{sent_count}/{len(email_addresses)}")
            box_fm.destroy()
            print("Mail Sent Successfully.")
